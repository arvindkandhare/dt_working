...
#red_left_tofirststack_original = [(-66.948, 66.505), (-64.771, 81.588), (-63.049, 96.73), (-60.55, 111.758), (-59.156, 118.226), (-59.156, 118.226)]
red_left_tofirststack = [(-81.225, 139.181), (-69.076, 130.011), (-59.156, 118.226), (-59.156, 118.226)]
...
#first_red_left_4_original = [(-38.418, 106.242), (-38.361, 108.24), (-38.381, 110.238), (-38.496, 112.234), (-38.698, 114.222), (-39.011, 116.196), (-39.423, 118.152), (-39.944, 120.081), (-40.582, 121.976), (-41.329, 123.829), (-42.187, 125.634), (-43.158, 127.381), (-44.235, 129.065), (-45.408, 130.682), (-46.672, 132.231), (-48.025, 133.702), (-49.454, 135.1), (-50.949, 136.426), (-52.506, 137.679), (-54.118, 138.861), (-55.775, 139.979), (-57.476, 141.029), (-59.211, 142.021), (-60.978, 142.955), (-62.773, 143.836), (-64.591, 144.665), (-66.43, 145.448), (-68.289, 146.184), (-70.162, 146.882), (-72.05, 147.538), (-73.95, 148.159), (-75.861, 148.747), (-77.782, 149.301), (-79.711, 149.825), (-81.647, 150.323), (-83.589, 150.793), (-85.538, 151.238), (-87.492, 151.66), (-89.45, 152.061), (-91.413, 152.442), (-93.379, 152.802), (-95.349, 153.144), (-97.321, 153.469), (-99.296, 153.778), (-101.273, 154.071), (-103.252, 154.351), (-105.234, 154.617), (-107.217, 154.87), (-109.201, 155.11), (-111.187, 155.339), (-113.174, 155.557), (-115.162, 155.765), (-117.151, 155.964), (-119.141, 156.153), (-121.132, 156.334), (-123.123, 156.507), (-125.115, 156.672), (-127.108, 156.831), (-129.101, 156.982), (-131.095, 157.127), (-133.089, 157.266), (-135.084, 157.4), (-137.079, 157.528), (-139.074, 157.652), (-141.069, 157.771), (-143.065, 157.886), (-145.061, 157.998), (-147.057, 158.106), (-149.053, 158.21), (-151.049, 158.312), (-153.046, 158.411), (-155.043, 158.507), (-157.039, 158.602), (-159.036, 158.694), (-161.033, 158.785), (-163.03, 158.875), (-165.027, 158.964), (-167.024, 159.051), (-169.021, 159.139), (-171.018, 159.225), (-171.42, 159.243), (-171.42, 159.243)]
first_red_left_4 = [(-135.526, -18.173), (-136.232, -16.303), (-136.93, -14.429), (-137.619, -12.553), (-138.299, -10.673), (-138.971, -8.791), (-139.635, -6.905), (-140.29, -5.017), (-140.937, -3.125), (-141.575, -1.231), (-142.204, 0.667), (-142.825, 2.567), (-143.437, 4.47), (-144.041, 6.375), (-144.636, 8.284), (-145.223, 10.195), (-145.801, 12.108), (-146.371, 14.024), (-146.933, 15.942), (-147.486, 17.863), (-148.032, 19.786), (-148.569, 21.712), (-149.098, 23.64), (-149.618, 25.57), (-150.131, 27.502), (-150.636, 29.436), (-151.132, 31.372), (-151.621, 33.311), (-152.102, 35.251), (-152.575, 37.193), (-153.04, 39.137), (-153.498, 41.083), (-153.948, 43.031), (-154.39, 44.98), (-154.825, 46.931), (-155.253, 48.884), (-155.673, 50.838), (-156.086, 52.794), (-156.492, 54.751), (-156.891, 56.71), (-157.283, 58.67), (-157.668, 60.632), (-158.046, 62.595), (-158.417, 64.559), (-158.782, 66.524), (-159.14, 68.491), (-159.492, 70.459), (-159.837, 72.428), (-160.177, 74.398), (-160.51, 76.369), (-160.837, 78.341), (-161.159, 80.314), (-161.474, 82.288), (-161.785, 84.262), (-162.09, 86.238), (-162.39, 88.214), (-162.684, 90.191), (-162.974, 92.169), (-163.259, 94.148), (-163.539, 96.127), (-163.814, 98.107), (-164.086, 100.087), (-164.353, 102.068), (-164.617, 104.05), (-164.877, 106.032), (-165.133, 108.014), (-165.386, 109.997), (-165.636, 111.981), (-165.883, 113.964), (-166.127, 115.948), (-166.369, 117.933), (-166.609, 119.917), (-166.847, 121.902), (-167.083, 123.887), (-167.318, 125.872), (-167.553, 127.857), (-167.786, 129.842), (-168.019, 131.828), (-168.252, 133.813), (-168.486, 135.798), (-168.72, 137.784), (-168.955, 139.769), (-169.192, 141.754)]
...
red_left_middle = [(-62.038, 56.275), (-63.461, 54.87), (-64.885, 53.465), (-66.308, 52.06), (-67.732, 50.655), (-69.155, 49.25), (-70.579, 47.846), (-72.002, 46.441), (-73.426, 45.036), (-74.849, 43.631), (-76.273, 42.226), (-77.696, 40.821), (-79.12, 39.416), (-80.543, 38.011), (-81.967, 36.606), (-83.39, 35.201), (-84.813, 33.797), (-86.237, 32.392), (-87.66, 30.987), (-89.084, 29.582), (-90.507, 28.177), (-91.931, 26.772), (-93.354, 25.367), (-94.778, 23.962), (-96.201, 22.557), (-97.625, 21.152), (-99.048, 19.748), (-100.472, 18.343), (-101.895, 16.938), (-103.319, 15.533), (-104.742, 14.128), (-106.165, 12.723), (-107.589, 11.318), (-109.012, 9.913), (-110.436, 8.508), (-111.859, 7.103), (-113.283, 5.699), (-114.706, 4.294), (-116.13, 2.889), (-117.553, 1.484), (-118.977, 0.079), (-120.4, -1.326), (-121.824, -2.731), (-123.247, -4.136), (-124.67, -5.541), (-126.094, -6.946), (-127.517, -8.35), (-128.941, -9.755), (-130.125, -10.924), (-130.125, -10.924)]
...
red_right_middle = [((x), -y) for x, y in red_left_middle]
...
def autonomous_mogo_side(tomogo):
    ...
    # Go to the 4 stack of rings in the corner
    update_position()
    walk_path(first_4, lookahead, tolerance, 1)
    wait(300, MSEC)
    # Go to the stack of rings close to ladder
    update_position()
    walk_path(tofirststack, 10, tolerance, 1)
    wait(300, MSEC)
    #Get away from current location
    update_position()
    walk_path(tower_position, 10, tolerance, -1)
    # Rotate and touch tower
    update_position()
...
def check_vision_sensor(eject_object):
    #print("reached here")
    #print(eject_object)
...
def autonomous_test():
    ...
    walk_path(topleftmogo2, lookahead, 2, -1)
    mogo_p.set(False)
    wait(500, MSEC)
    intake_state = IntakeState.STOPPED
    set_intake_motor_state(REVERSE)
