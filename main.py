...
def update_position():
    global current_x, current_y, current_angle, previous_left_encoder, previous_right_encoder, robot_not_walking, position_debug
...
def walk_path(points_list, lookahead_distance, stop_threshold, direction, decl = False, decl_dis = 22, decl_rate = 0.6, last_point_tolerance = 2.5):
    ...
    left_rotational_sensor.changed(update_position)
    right_rotational_sensor.changed(update_position)
    ...
    #print(dis_to_end)
    left_rotational_sensor.changed(lambda: None)
    right_rotational_sensor.changed(lambda: None)
